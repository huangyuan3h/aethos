  ...
  settings: {
    ...
    theme: {
      ...
      library: {
        ...
        description: 'Gérez les thèmes intégrés et vos créations.',
        new: 'Nouveau thème',
        newName: 'Nouveau thème',
        edit: 'Modifier',
      ...
      editor: {
        ...
        description: 'Ajustez les couleurs et la typographie du thème sélectionné.',
        placeholder: 'Sélectionnez un thème à personnaliser.',
        name: 'Nom du thème',
        mode: 'Mode',
        fontSize: 'Taille du texte (px)',
        headingScale: 'Échelle des titres',
        lineHeight: 'Interligne',
        readonly: 'Les thèmes intégrés sont en lecture seule. Dupliquez-les pour les modifier.',
        reset: 'Réinitialiser',
